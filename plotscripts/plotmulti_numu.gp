...
set arrow 8 from 1e-12,3.36e-5 to 1e-8,3.36e-5 nohead lc rgb 'orange'
set label 9 "our BBN at {/Symbol m}=0" at graph 0.1,graph 0.8 tc rgb 'orange'
plot "bbang_numu.dat" u 1:4 w l linetype 1 lc rgb "black" lw 3
...
set label 3 "obs. Y=0.2465 +/- 0.0097" at graph 0.1,graph 0.6 tc rgb 'blue'
set arrow 4 from 1e-12,0.249 to 1e-8,0.249 nohead lc rgb 'red' lw 2.0
set label 5 "unmodified Cyburt BBN" at graph 0.1,graph 0.7 tc rgb 'red'
set arrow 6 from 1e-12,0.249 to 1e-8,0.249 nohead lc rgb 'green' lw 1.0
set label 7 "unmodified Timmes BBN" at graph 0.1,graph 0.8 tc rgb 'green'
set arrow 8 from 1e-12,0.250 to 1e-8,0.250 nohead lc rgb 'orange'
set label 9 "our BBN at {/Symbol m}=0" at graph 0.1,graph 0.9 tc rgb 'orange'
plot "bbang_numu.dat" u 1:6 w l linetype 1 lc rgb "black" lw 3
...
set label 5 "unmodified Cyburt BBN" at graph 0.1,graph 0.4 tc rgb 'red'
set arrow 6 from 1e-12,0.7514 to 1e-8,0.7514 nohead lc rgb 'green' lw 1.0
set label 7 "unmodified Timmes BBN" at graph 0.1,graph 0.5 tc rgb 'green'
set arrow 8 from 1e-12,0.7504 to 1e-8,0.7504 nohead lc rgb 'orange'
set label 9 "our BBN at {/Symbol m}=0" at graph 0.1,graph 0.6 tc rgb 'orange'
plot "bbang_numu.dat" u 1:3 w l linetype 1 lc rgb "black" lw 3
...
set format y "%10.1E"
set yrange [1.0e-9:3.5e-9]
set ylabel "Li7" offset +4,+0
set output "bb_abundances_li7.eps"
plot "bbang_numu.dat" u 1:8 w l linetype 1 lc rgb "black" lw 3
